export const countries = [
  ...
  },
  {
    ...
    capital: "Georgetown",
    interestingFact:
      "Guyana is home to the world's largest single-drop waterfall, Kaieteur Falls, as well as to a diverse population of indigenous peoples and immigrants from around the world.",
  },
  {
    name: "Haiti",
    ...
    interestingFact:
      "Haiti is the only country in the world that gained independence as a result of a successful slave rebellion, which ended in 1804.",
  },
  {
    name: "Honduras",
    ...
    capital: "Tegucigalpa",
    interestingFact:
      "Honduras is home to the ancient Maya city of Copán, which contains some of the best-preserved Maya ruins in Central America.",
  },
  {
    name: "Hungary",
    ...
    capital: "Budapest",
    interestingFact:
      "Hungary is known for its thermal baths, which are fed by natural hot springs and are popular with both locals and tourists.",
  },
  {
    name: "India",
  ...
  },
  {
    ...
    capital: "Jakarta",
    interestingFact:
      "Indonesia is the world's largest archipelago, made up of more than 17,000 islands.",
  },
  {
    name: "Iran",
    population: "Approximately 83 million people",
